...
class Dependency(abc.ABC):
    ...
    def __init__(
        ...
        *inputs: AbstractAttribute,
        ...
        self._set_up_command(*self._inputs)
    ...
    def replace_input(self, input: AbstractAttribute, new_input: AbstractAttribute) -> None:
        ...
        self._set_up_command(new_input)
    ...
    def _set_up_command(self, *inputs: AbstractAttribute):
...
class Attribute_List(AbstractAttribute):
    ...
    def __init__(
        ...
        self._attributes: list[AbstractAttribute] = list()
    ...
    def add_dependency(
        self, func: Callable[[Any], Any], *attributes: AbstractAttribute, **kwargs
    ) -> Dependency:
        if any([item.dependent for item in self._attributes]):
    ...
    def append(self, attribute: AbstractAttribute) -> None:
        ...
        self._check_new_attribute_type(attribute)
    ...
    def copy(self) -> Attribute_List:
        ...
        for item in self._attributes:
            the_copy._attributes.append(item.copy())
        return the_copy

    def is_valid(self, values: list[Any]) -> bool:
        return all([attr.is_valid(value) for attr, value in zip(self._attributes, values)])
    ...
    def _remove(self, attributes: AbstractAttribute) -> None:
        self._attributes.remove(attributes)
    ...
    def _check_new_attribute_type(self, attr: AbstractAttribute) -> None:
...
class Attribute(AbstractAttribute):
    ...
    def __init__(
        ...
        self._actions: list[Callable[[Attribute], None]] = list()

        self._actions_on_set: dict[str, Callable[[], None]] = dict()
    ...
    @property
    def custom_condition(self) -> Callable:
        return self._custom_condition

    def add_action_on_set(self, owner_id: str, action: Callable[[], None]) -> None:
        self._actions_on_set[owner_id] = action

    def remove_action_on_set(self, owner_id: str) -> None:
        self._actions_on_set.pop(owner_id)
    ...
    def is_valid(self, value: Any, raise_value_type_exception: bool = True) -> bool:
        if not self._is_type_valid(value):
            if raise_value_type_exception:
                ...
                return False
        return self._is_value_valid(value) and self._custom_condition(value)
    ...
    def _value_update(self, value: Any, msg: str = "") -> None:
        self._value = value
        self._run_actions_after_setting_the_value()

    def _run_actions_after_setting_the_value(self) -> None:
        for action in self._actions:
            action(self)
        for action_on_set in self._actions_on_set.values():
            action_on_set()
...
class Monetary_Attribute(Number_Attribute):
    ...
    def print(
        ...
        *options,
        ...
        if show_symbol:
            value_str = self._add_symbol_to_printed_value(value_str, currency)
    ...
    def value_from_text(text: str, *args) -> Any:
        ...
        sign, _, value = Monetary_Attribute._extract_sign_symbol_and_value(text)
    ...
    @staticmethod
    def _extract_sign_symbol_and_value(text: str) -> tuple[str, str, str]:
        sign, text = Monetary_Attribute._extract_sign(text)
    ...
    @staticmethod
    def _extract_sign(text: str) -> tuple[str, str]:
        if text[0] in ("+", "-"):
    ...
    def _add_symbol_to_printed_value(self, value: str, currency: Currency) -> str:
...
class Text_Attribute(Attribute):
    ...
    @staticmethod
    def value_from_text(text: str, *args) -> str:
        return text
...
class Date_Attribute(Attribute):
    ...
    @staticmethod
    def _extract_date_from_string(text: str) -> None | dict:
        text = Date_Attribute._remove_spaces(text)
    ...
    @staticmethod
    def value_from_text(text: str, *args) -> datetime.date:
        date = Date_Attribute._extract_date_from_string(text)
        if date is None:
...
class Bool_Attribute(Attribute):
    ...
    @staticmethod
    def value_from_text(text: str, *args) -> bool:
...
class Quantity(Real_Attribute):
    ...
    def add_prefix(self, unit: str, prefix: str, exponent: int) -> None:
        self._check_unit_is_defined(unit)
        Quantity._check_exponent(prefix, exponent)
    ...
    def add_unit(
        ...
        self.__units[symbol] = Quantity._create_unit(
            symbol,
            exponents,
            space_after_value,
    ...
    def read_only_value(self, text: str, overwrite_dependent: bool = False) -> None:
        ...
        self._value = self._readjust_func(self.__unit.to_basic(self._value))
    ...
    def _adjust_func(self, value: Decimal | float) -> Decimal:
    ...
    def _readjust_func(self, value: Decimal | float) -> Decimal:
        value = self.__unit.from_basic(value)
        decimal_shift = Decimal(self.__unit.exponents[self.__prefix])
        return Decimal(value) * Decimal("10") ** decimal_shift

    def _check_unit_is_defined(self, unit_symbol: str) -> None:
    ...
    @staticmethod
    def _check_exponent(prefix, exponent) -> None:
...
class Attribute_Factory:
    ...
    def __post_init__(self) -> None:
        ...
        self._verify_and_format_locale_code()
    ...
    def _verify_and_format_locale_code(self) -> None:
